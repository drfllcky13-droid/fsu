...
const CHANGELOG=[
  ["2026-09-26","In Safari, when the app is not on the Home Screen and the browser has not agreed to keep its storage, a bar warns that Safari deletes everything after 7 days unopened and shows how to add it to the Home Screen. Settings › This device shows how full storage is, Home and Scenes warn at 70%, and closed cases already safe in an unchanged case package can be removed after a confirm that lists exactly what goes."],
