  ...
  if(k==="who")body=`
    ...
    <p class="hint" style="margin:0 0 12px">${storageState.persisted
      ...
      : isStandalone()||!onApple()
        ? "Everything you enter is written to this device as you go. The browser has not yet marked it as protected storage, so it may clear it if the device runs short of space. Installing the app, or using it regularly, normally makes it protected. Keep a backup until it does."
